...
-  [BetterScroll.js ｜为移动端（已支持 PC）各种滚动场景提供丝滑的滚动效果](https://better-scroll.github.io/docs/zh-CN/)  
-  [store.js｜ store.js 是一个兼容所有浏览器的 LocalStorage 包装器](https://www.npmjs.com/package/storejs) 
...
- [广告人的导航网站](https://www.addog.vip/)
- [大数据网址导航](http://hao.199it.com/)
- [https://www.24kdh.com/](https://www.24kdh.com/)
- [程序员导航](https://cxy521.com/)
- [awesome-bookmarks | 一位大佬的书签收藏夹网站](https://panjiachen.github.io/awesome-bookmarks/) 
- [技术胖的收藏夹](./jspang.md)

## 八、拓展知识

- [全历史 | 一个学习历史知识的网站](https://www.allhistory.com/)
- [渣男说话的艺术 | 平时消遣的网站](https://lovelive.tools/)
